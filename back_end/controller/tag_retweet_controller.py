...
@retweet.get('/topic_detail_relation_graph', response_model=RESTfulModel,
             description='转发关系网络图的数据', summary='获取网络图数据')
async def get_relation_graph(topic: str, mongo_db: AsyncIOMotorDatabase = Depends(get_mongo_db)):
