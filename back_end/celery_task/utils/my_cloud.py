...
class MyCloud:
    def __init__(self, content: list):
        ...
        # TODO path
        self.stop_words = [w.strip() for w in open('D:\\dasanshang\\NLP\\1\\Topic_and_user_profile_analysis_system\\code\\back_end\\dict\\哈工大停用词表.txt', 'r', encoding='UTF-8').readlines()]
